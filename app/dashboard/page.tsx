...
export default function HospitalDashboard() {
  ...
  return (
    <div className="flex h-screen bg-[#F4F7F6] text-[#1E293B] antialiased font-sans">
      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        {/* PANEL MONITOR UTAMA */}
        <section className="flex-1 bg-white p-6 overflow-y-auto flex flex-col">
          ...
          <div className="border border-slate-200 rounded-lg p-5 bg-slate-50 mb-6 flex justify-between items-start">
            <div className="text-left">
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-xl font-black tracking-tight text-slate-900">{selectedAmb.patient.name}</h1>
                <span className={`px-2.5 py-1 rounded text-xs font-bold text-white tracking-wide ${
            ...
            <div className="text-right border-l border-slate-200 pl-6">
              ...
              <div className="px-3 py-1.5 bg-white border border-slate-200 rounded text-sm font-bold text-slate-900 inline-block">
                ⚠️ {selectedAmb.patient.complaint}
              </div>
            </div>
          </div>
