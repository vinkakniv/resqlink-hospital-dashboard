        ...
        <table className="w-full text-sm text-left border-collapse bg-white">
          ...
          <tbody className="divide-y divide-slate-200">
            <tr>
              ...
              <td className="px-4 py-3.5"><span className="text-xs bg-blue-50 text-blue-700 px-2 py-0.5 rounded font-medium border border-blue-200">Terpantau</span></td>
            </tr>
            <tr>
              ...
              <td className="px-4 py-3.5"><span className="text-xs bg-slate-100 text-slate-700 px-2 py-0.5 rounded font-medium border border-slate-200">Normal Tinggi</span></td>
            </tr>
            <tr>
              ...
              <td className="px-4 py-3.5">
                {isHypoxia ? (
                  <span className="text-xs bg-red-50 text-red-700 px-2 py-0.5 rounded font-bold border border-red-200 animate-pulse">
            ...
            <tr>
              ...
              <td className="px-4 py-3.5"><span className="text-xs bg-amber-50 text-amber-700 px-2 py-0.5 rounded font-medium border border-amber-200">Takikardia Ringan</span></td>
            </tr>
          </tbody>
        </table>
      </div>
